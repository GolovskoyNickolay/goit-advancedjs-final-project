const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/search-C0UI3lRV.js","assets/favourites-D4E0UFt3.js","assets/vendor-BAoYjrW1.js","assets/vendor-D_nxXpU-.css","assets/pagination-s98Ijyzy.js"])))=>i.map(i=>d[i]);
var f=Object.defineProperty;var x=(r,e,t)=>e in r?f(r,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):r[e]=t;var c=(r,e,t)=>x(r,typeof e!="symbol"?e+"":e,t);import{i as E,_ as v,s as g,g as L,c as b,f as k,I as h,a as d,u as $,b as S,d as w,r as M,e as F,E as I}from"./favourites-D4E0UFt3.js";/* empty css               */import{i as u}from"./vendor-BAoYjrW1.js";class m{constructor(e,t,i){c(this,"onClick",({target:e})=>{e.nodeName==="LI"&&(this.filter=e.dataset.filter,this.setActiveFilter(this.filter),this.exerciseInstance.hide(),this.render(),this.setActivePath(),g.new("category",this.filter))});c(this,"paginationCategoryCallback",e=>{this.render(Number(e))});c(this,"cardOnClick",({target:e})=>{const t=k(e,"LI","UL");if(!t)return;this.hide();const{exercise:i}=t.dataset;this.exerciseInstance.init(this.filter,i),this.setActivePath(i),g.set("exercise",i)});this.exerciseInstance=t,this.paginationInstance=i,this.filterList=document.body.querySelector(".filters-list"),this.filterList.addEventListener("click",this.onClick),this.items=Array.from(this.filterList.querySelectorAll("li")),this.categoryList=document.body.querySelector(".category-list"),this.categoryList.addEventListener("click",this.cardOnClick),this.filter="Muscles",this.path={start:document.querySelector(".filter-path-start"),part:document.querySelector(".filter-path-part")},this.limit=E()?9:12,this.errorElement=document.body.querySelector("[data-categoryError]"),e&&async function(s){const a=await v(()=>import("./search-C0UI3lRV.js"),__vite__mapDeps([0,1,2,3]));s.searchForm=a.default}(this)}setActiveFilter(e){this.items.forEach(t=>{t.dataset.filter===e?t.classList.add("active"):t.classList.remove("active")})}setActivePath(e=""){e?this.path.start.innerHTML="Exercises /":this.path.start.innerHTML="Exercises",this.path.part.innerHTML=e}async render(e=1){var t;try{const i=await L({filter:this.filter,limit:this.limit,page:e});i.results.length?(this.errorHide(),this.categoryList.innerHTML=i.results.map(m.categoryMarkup).join("")):(this.categoryList.innerHTML="",this.errorShow()),this.paginationInstance.render(i.totalPages,i.page),this.paginationInstance.callback=this.paginationCategoryCallback,(t=this.searchForm)==null||t.hide(),this.show()}catch{iziToast.error({title:"Unexpected error",message:"Try to refresh the page",position:"topRight"})}}static categoryMarkup({imgURL:e,name:t,filter:i}){return`<li class="category-card" data-muscle="${i}" data-exercise="${t}">
          <img
            src="${e}"
          ...
          <div class="category-content">
            <h3 class="category-title">${b(t)}</h3>
            <p class="category-subtitle">${i}</p>
          </div>
        </li>`}show(){this.categoryList.classList.remove(h),this.categoryList.hidden=!1}hide(){this.categoryList.classList.add(h),this.categoryList.hidden=!0,this.errorHide()}errorShow(e="Category was not found"){this.errorElement.innerHTML=e,this.errorElement.classList.remove(h),this.errorElement.hidden=!1}errorHide(){this.errorElement.innerHTML="",this.errorElement.classList.add(h),this.errorElement.hidden=!0}}class O{constructor(e,t){c(this,"createRatingStars",()=>`
  ...
  `);this.modalBody=e,this.exerciseId=null,this.backToExercise=t}setupStarsUpdate(){const e=this.modalBody.querySelectorAll('input[name="rating"]'),t=this.modalBody.querySelector(".rating-options-value");e.forEach(i=>{i.addEventListener("change",()=>{t.textContent=`${parseFloat(i.value).toFixed(1)}`})})}open(e){this.exerciseId=e,this.modalBody.innerHTML=`
    ...
    `,this.modalBody.querySelector(".rating-form").addEventListener("submit",i=>this.handleSubmit(i)),this.setupStarsUpdate()}async handleSubmit(e){e.preventDefault();const t=e.target,i=new FormData(t),s=i.get("rating"),a=i.get("email"),n=i.get("comment");if(!s||!a||!n){u.error({title:"Error",message:"Please fill in all fields!",position:"topRight"});return}const o={rate:Number(s),email:a,review:n};try{const l=await $(this.exerciseId,o);console.log(l),u.success({title:"Update rating",message:"Update was successfully!",position:"topRight"}),this.close()}catch(l){u.error({title:"Update Error",message:l.message,position:"topRight"})}}close(){this.modalBody.innerHTML="",this.exerciseId=null,this.backToExercise()}}class C{constructor(){this.modalOverlay=document.querySelector(".modal-overlay"),this.modal=document.getElementById("exerciseModal"),this.modalBody=document.querySelector(".modal-body"),this.closeBtn=this.modal.querySelector(".modal-close"),this.ratingModal=new O(this.modalBody,this.render.bind(this)),this.exercise=null,this.isFavorite=!1,this.isRatingOpen=!1,this.handleOverlayClick=this.handleOverlayClick.bind(this),this.handleEscKey=this.handleEscKey.bind(this),this.handleClose=this.handleClose.bind(this)}async open(e){const t=e.target.closest(".workout-card");if(!t)return;const i=t.dataset.id;this.modalOverlay.classList.add("is-open"),this.modalBody.innerHTML=this.createSkeletonMarkup();try{this.exercise=await S(i),this.isFavorite=w(this.exercise._id),this.render(),this.modalOverlay.addEventListener("click",this.handleOverlayClick),window.addEventListener("keydown",this.handleEscKey),this.closeBtn.addEventListener("click",this.handleClose)}catch(s){u.error({title:"Request exercise Error",message:s==null?void 0:s.message,position:"topRight"}),console.error(s),this.modalBody.innerHTML='<p class="error">Failed to load exercise. Try again later.</p>'}}close(){this.modalOverlay.classList.remove("is-open"),this.exercise=null,this.isFavorite=!1,this.isRatingOpen=!1,this.modalOverlay.removeEventListener("click",this.handleOverlayClick),this.closeBtn.removeEventListener("click",this.handleClose),window.removeEventListener("keydown",this.handleEscKey)}render(){this.modalBody.innerHTML=this.createExerciseMarkup(),this.addEventListeners()}addEventListeners(){const e=this.modal.querySelector(".favorites-btn"),t=this.modal.querySelector(".rate-btn");e.addEventListener("click",()=>this.toggleFavorite(e)),t.addEventListener("click",()=>{this.ratingModal.open(this.exercise._id),this.isRatingOpen=!0})}toggleFavorite(e){this.isFavorite?(M(this.exercise._id),this.isFavorite=!1):(F(this.exercise),this.isFavorite=!0),this.updateFavoritesButton(e)}updateFavoritesButton(e){e.innerHTML=`
      ...
      <svg class="icon-heart" height="18" width="20">
        <use href="${d}#${this.isFavorite?"icon-trash":"icon-heart"}"></use>
      </svg>
  ...
  `}}async function B(){const e=(await v(()=>import("./pagination-s98Ijyzy.js"),__vite__mapDeps([4,1,2,3]))).default,t=!0,i=new C,s=new I(t,e,i),a=new m(t,s,e),{category:n,exercise:o,keyword:l,page:p}=Object.fromEntries(g.initParams.entries());if(n&&o)setTimeout(()=>{s.init(n,o,l,p),a.setActiveFilter(n),a.setActivePath(o)},50);else if(n){const y=["Muscles","Body parts","Equipment"].indexOf(n);a.onClick({target:document.querySelectorAll(".filters-list .filters-item")[y]})}else a.onClick({target:document.querySelector(".filters-list .filters-item")})}B();
//# sourceMappingURL=main-CbRA1Per.js.map
